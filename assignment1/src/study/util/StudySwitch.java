 ...
 * @generated
 */
public class StudySwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case StudyPackage.STUDY_PROGRAMME: {
				StudyProgramme studyProgramme = (StudyProgramme)theEObject;
				T result = caseStudyProgramme(studyProgramme);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case StudyPackage.INDIVIDUAL_STUDY_PLAN: {
				IndividualStudyPlan individualStudyPlan = (IndividualStudyPlan)theEObject;
				T result = caseIndividualStudyPlan(individualStudyPlan);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StudyPackage.COURSE_RELATIONSHIP: {
				CourseRelationship courseRelationship = (CourseRelationship)theEObject;
				T result = caseCourseRelationship(courseRelationship);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseStudyProgramme(StudyProgramme object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Individual Study Plan</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Individual Study Plan</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseIndividualStudyPlan(IndividualStudyPlan object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Course Relationship</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Course Relationship</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCourseRelationship(CourseRelationship object) {
		return null;
	}
